    ...
    if int_income <=132000: ##No tax payable##
        ...
        if net_chargeable_income > 0:
            if Check <= 49999:               
                ...
                t1=net_chargeable_income-50000
                tax=int((t1*0.06)+1000)
                
                return tax
            elif Check >= 100000 and Check <=149999:
                t1=net_chargeable_income-100000
                tax= int((t1*0.1)+4000)
                
                return tax
            elif Check >= 150000 and Check <=199999:
                t1=net_chargeable_income-150000
                tax=int((t1*0.14)+9000)
                
                return tax
            elif Check >= 200000:
                t1=net_chargeable_income-200000
                tax=int((t1*0.17)+16000)
                
                return tax
           
    else:
        t2=int_income-int_mpf
        tax=int(t2*0.15)
